...
alter table BC_IDENTITY_ACTOR
  add constraint FK_ACTOR_ACTORDETAIL foreign key (DETAIL_ID)
...
alter table BC_IDENTITY_ACTOR_RELATION
  add constraint FK_AR_MASTER foreign key (MASTER_ID)
references BC_IDENTITY_ACTOR (ID);
alter table BC_IDENTITY_ACTOR_RELATION
  add constraint FK_AR_FOLLOWER foreign key (FOLLOWER_ID)
references BC_IDENTITY_ACTOR (ID);
...
alter table BC_SECURITY_ROLE_ACTOR
  add constraint FK_RA_ACTOR foreign key (AID)
references BC_IDENTITY_ACTOR (ID);
alter table BC_SECURITY_ROLE_ACTOR
  add constraint FK_RA_ROLE foreign key (RID)
