...
<div title='<s:text name="unit.title"/>' data-type='form' class="bc-page"
	...
	data-js='<s:url value="/bc/identity/unit/form.js" />,js:bc_identity'
	...
	<s:form name="unitForm" theme="simple">
		<table class="formTable2 ui-widget-content" cellspacing="2" cellpadding="0">
			...
			<tr>
				...
				<td class="value relative"><s:textfield name="belongNames" cssClass="ui-widget-content" readonly="true"/>
					<ul class="inputIcons">
						...
						<li class="clearSelect inputIcon ui-icon ui-icon-circle-close" 
							data-cfg='belongIds,belongNames'
