...
@Controller
public class SelectUnitOrDepartmentsAction extends
  ...
  protected SqlObject<Map<String, Object>> getSqlObject() {
    ...
    if (this.history) {
      ...
      sql.append(" a.pname||'/'||a.name end as name,a.name cname,a.pcode,a.pname,getfollowercountbyunitdepartment(a.id)");
  ...
  protected List<Column> getGridColumns() {
    ...
    columns.add(new TextColumn4MapKey("a.name", "name",
      getText("unitOrDepartment"), 40).setSortable(true)
  ...
  protected String getHtmlPageTitle() {
    return this.getText("unitOrDepartment.title.select");
  }
  ...
  protected HtmlPage buildHtmlPage() {
    return super.buildHtmlPage().setNamespace(
      this.getHtmlPageNamespace() + "/selectUnitOrDepartments");
  }

  @Override
  protected String getHtmlPageJs() {
    return this.getHtmlPageNamespace()
      + "/identity/unitOrDepartment/select.js";
  }
  ...
  protected Condition getGridSpecalCondition() {
    ...
    String type[] = {String.valueOf(Actor.TYPE_UNIT),
      String.valueOf(Actor.TYPE_DEPARTMENT)};
    typeCondition = new InCondition("a.type_",
      StringUtils.stringArray2IntegerArray(type));
    if (history) {
  ...
  protected String getClickOkMethod() {
    return "bc.unitOrDepartmentSelectDialog.clickOk";
  }
