...
public class IdGeneratorDaoImpl implements IdGeneratorDao {
	...
	public Long currentValue(String type) {
		...
		Integer v = JpaUtils.getSingleResult(JpaUtils.createNativeQuery(entityManager, sql, new Object[]{type}));
	...
	public Long getNextval() {
		...
		Integer v = JpaUtils.getSingleResult(JpaUtils.createNativeQuery(entityManager, sql, (Object[]) null));
		if (v == null) return null;
		return new Long(v);
	}
}