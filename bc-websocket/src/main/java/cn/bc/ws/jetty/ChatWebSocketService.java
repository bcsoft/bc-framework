...
public interface ChatWebSocketService {
   ...
   * 发送信息给指定的连接
   *
   * @param fromSid 发送者的sid
   * @param toSid   接收者的sid
   * @param type    消息的类型，见ChatWebSocket.TYPE_XXX常数的定义
   * @param msg     要发送的信息
   */
   ...
   * 系统回发信息给自己
   *
   * @param fromSid 原发送者的sid
   * @param toSid   原接收者的sid
   * @param msg     要发送的信息
   */
