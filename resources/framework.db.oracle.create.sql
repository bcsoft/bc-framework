...
CREATE TABLE BC_BULLETIN (
    ...
    AUTHOR_DEPART_ID number(19),
    AUTHOR_DEPART_NAME varchar2(255),
    AUTHOR_UNIT_ID number(19) NOT NULL,
    AUTHOR_UNIT_NAME varchar2(255) NOT NULL,
...
COMMENT ON COLUMN BC_BULLETIN.AUTHOR_DEPART_ID IS '创建人所在部门ID，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_BULLETIN.AUTHOR_DEPART_NAME IS '创建人所在部门名称，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_BULLETIN.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BC_BULLETIN.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
ALTER TABLE BC_BULLETIN ADD CONSTRAINT BCFK_BULLETIN_ISSUER FOREIGN KEY (ISSUER_ID) 
	REFERENCES BC_IDENTITY_ACTOR (ID);
CREATE INDEX BCIDX_BULLETIN_SEARCH ON BC_BULLETIN (SCOPE,AUTHOR_UNIT_ID,STATUS_);
CREATE INDEX BCIDX_BULLETIN_ARCHIVE ON BC_BULLETIN (SCOPE,AUTHOR_UNIT_ID,STATUS_,FILE_YEAR,FILE_MONTH,FILE_DAY);
...
COMMENT ON COLUMN BC_DOCS_ATTACH.AUTHOR_DEPART_ID IS '创建人所在部门ID，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_DOCS_ATTACH.AUTHOR_DEPART_NAME IS '创建人所在部门名称，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_DOCS_ATTACH.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BC_DOCS_ATTACH.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
COMMENT ON COLUMN BC_DOCS_ATTACH_HISTORY.AUTHOR_DEPART_ID IS '创建人所在部门ID，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_DOCS_ATTACH_HISTORY.AUTHOR_DEPART_NAME IS '创建人所在部门名称，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_DOCS_ATTACH_HISTORY.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BC_DOCS_ATTACH_HISTORY.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
COMMENT ON COLUMN BC_FEEDBACK.AUTHOR_DEPART_ID IS '创建人所在部门ID，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_FEEDBACK.AUTHOR_DEPART_NAME IS '创建人所在部门名称，如果用户直接隶属于单位，则为null';
COMMENT ON COLUMN BC_FEEDBACK.AUTHOR_UNIT_ID IS '创建人所在单位ID';
COMMENT ON COLUMN BC_FEEDBACK.AUTHOR_UNIT_NAME IS '创建人所在单位名称';
...
ALTER TABLE BC_FEEDBACK ADD CONSTRAINT BCFK_FEEDBACK_AUTHOR FOREIGN KEY (AUTHOR_ID) 
	REFERENCES BC_IDENTITY_ACTOR (ID);
CREATE INDEX BCIDX_FEEDBACK_SEARCH ON BC_FEEDBACK (AUTHOR_UNIT_ID,STATUS_);
CREATE INDEX BCIDX_FEEDBACK_ARCHIVE ON BC_FEEDBACK (AUTHOR_UNIT_ID,STATUS_,FILE_YEAR,FILE_MONTH,FILE_DAY);
