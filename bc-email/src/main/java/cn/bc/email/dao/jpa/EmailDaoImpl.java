 ...
 * @author dragon
 */
public class EmailDaoImpl extends JpaCrudDao<Email> implements EmailDao {
  ...
  public void mark(Long[] ids, Long receiver_id, boolean read) {
    ...
    this.jdbcTemplate.update(sql, new Object[]{read, receiver_id});
  }
  ...
  public void mark4read(Long receiver_id) {
    ...
    this.jdbcTemplate.update(sql, new Object[]{receiver_id});
  }
}