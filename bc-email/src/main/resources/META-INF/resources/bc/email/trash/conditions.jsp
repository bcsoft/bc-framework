...
<form class="bc-conditionsForm draggable ui-widget-content ui-state-highlight">
	<ul class="conditions" style="min-width:17.3em;">
		...
		<li class="condition">
			...
			<div class="value checkboxes" data-condition='{"type":"int","key":"t.src"}' >
				<label><input type="checkbox" name="checkboxField1" value="1"><span>发件箱</span></label>
				<label><input type="checkbox" name="checkboxField1" value="2"><span>收件箱</span></label>
			</div>
		</li>
	</ul>
</form>