 ...
 * @author LeeDane
 */
public class WorkdayDaoImpl extends JpaCrudDao<Workday> implements WorkdayDao {
	private static Logger logger = LoggerFactory.getLogger(WorkdayDaoImpl.class);
	...
	@Override
	public int getRealWorkingdays(Date fromDate, Date toDate, int workdaysEveryWeeks) {
