...
public class SpiderAction extends ActionSupport {
  ...
  private static Logger logger = LoggerFactory.getLogger(SpiderAction.class);
  ...
  public String execute() throws Exception {
    ...
    if (c.getConfigJson().has("width")) this.pageOption.setWidth(c.getConfigJson().getInt("width"));
    if (c.getConfigJson().has("height")) this.pageOption.setHeight(c.getConfigJson().getInt("height"));
  ...
  public String captcha() {
    ...
    try {
      ...
      if (path == null) {
        ...
        if (captcha != null) json.put("captcha", captcha);
      }
    } catch (Exception e) {
  ...
  public String run() {
    ...
    try {
      ...
      if (params != null) {
        ...
        Iterator<String> iterator = ps.keys();
        map = new HashMap<>();
        String key;
      ...
      if (r.isSuccess()) {
        ...
        json.put("success", false);
        json.put("error", r.getError() != null ? r.getError().getMessage() :
          r.getData() != null ? r.getData() : "no message");
        logger.warn(r.getError() != null ? r.getError().getMessage() : null, r.getError());
      }
    } catch (Exception e) {
      json.put("success", false);
  ...
  private String getDataString(Object data) {
    if (data == null) {
      ...
      return StringUtils.collectionToCommaDelimitedString((Collection) data);
    }
