...
public class TemplateServiceImpl extends DefaultCrudService<Template> implements
	...
	public Map<String, Object> findOneTemplateById(Integer id) {
		return (Map<String, Object>) this.getTemplateInfo(id, null, null, null,
				new HashMap<String, Object>());
	}

	@SuppressWarnings("unchecked")
	public Map<String, Object> findOneTemplateByCode(String code) {
		return (Map<String, Object>) this.getTemplateInfo(null, code, null,
	...
	private Object getTemplateInfo(Integer id, String code, String content,
			String inputStream, Map<String, Object> m) {
