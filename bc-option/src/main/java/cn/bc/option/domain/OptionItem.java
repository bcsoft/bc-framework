...
public class OptionItem extends EntityImpl {
   ...
   * @param currentKey     当前选项的key
   * @param currentValue   当前选项的value
   * @return
   */
   ...
   *
   * @param keyValues 键值对
   * @param sameKey   从keyValues中获取label和value的值的key
   * @return
   * @throws JSONException
   */
  public static JSONArray toLabelValues(List<Map<String, String>> keyValues,
   ...
   *
   * @param keyValues 键值对
   * @param labelKey  从keyValues中获取label值的key
   * @param valueKey  从keyValues中获取value值的key
   * @return
   * @throws JSONException
   */
  public static JSONArray toLabelValues(List<Map<String, String>> keyValues,
