...
public interface OptionService {
   ...
   * 获取选项条目的值
   *
   * @param groupKey 选项分组的Key
   * @param itemKey  选项条目的Key
   ...
   * 查找指定分类的选项条目列表
   *
   * @param optionGroupValue 所属分类，对应OptionGroup属性key的值
   * @return
   */
   ...
   * </p>
   *
   * @param optionGroupKey   所属分类，对应OptionGroup属性key的值
   * @param currentItemKey   当前选项的key
   * @param currentItemValue 当前选项的value
   * @return
   */
   ...
   * 批量查找指定分类的选项条目列表
   *
   * @param optionGroupKeys 所属分类，对应OptionGroup属性Key的值
